...
import { Shield, ShieldCheck, Volume2, VolumeX } from '@/components/icons'
...
export default function ManageMembersModal({
  ...
  return (
    ...
    >
      <div
        className="bg-slate-900/85 backdrop-blur-md rounded-2xl p-5 w-full max-w-md mx-4 shadow-floating  animate-menu-pop flex flex-col max-h-[80vh]"
      ...
      >
        ...
        {error && (
          <div className="mb-3 px-3 py-2 rounded-lg bg-rose-900/40  text-rose-200 text-xs">
            {error}
          </div>
        )}
